...
export class NextMigration1719899580285 implements MigrationInterface {
    name = 'NextMigration1719899580285'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "somthing" varchar NOT NULL)`);
